...
Rem LinuxARM
del "%cd%\release-builds\aqclassic_launcher-linux-armv7l\resources\app.asar.unpacked\resources\pepflashplayer_32.dll"
del "%cd%\release-builds\aqclassic_launcher-linux-armv7l\resources\app.asar.unpacked\resources\pepflashplayer_64.dll"
...
del "%cd%\release-builds\aqclassic_launcher-linux-ia32\resources\app.asar.unpacked\resources\pepflashplayer_32.dll"
del "%cd%\release-builds\aqclassic_launcher-linux-ia32\resources\app.asar.unpacked\resources\pepflashplayer_64.dll"
...
del "%cd%\release-builds\aqclassic_launcher-linux-x64\resources\app.asar.unpacked\resources\pepflashplayer_32.dll"
del "%cd%\release-builds\aqclassic_launcher-linux-x64\resources\app.asar.unpacked\resources\pepflashplayer_64.dll"
...
del "%cd%\release-builds\aqclassic_launcher-win32-ia32\resources\app.asar.unpacked\resources\pepflashplayer_64.dll"
...
del "%cd%\release-builds\aqclassic_launcher-win32-x64\resources\app.asar.unpacked\resources\pepflashplayer_32.dll"
